...
const Navbar = () => {
  ...
  return (
    <motion.nav
      className={`fixed z-10 left-0 top-0 right-0 w-full flex justify-between items-center px-4 gap-4 md:gap-12 py-0 lg:px-30 ${scrolled ? "bg-white/100 shadow-md" : "bg-transparent"}`}
    // variants={{
