    ...
    <div className="h-[500px] relative w-full lg:h-dvh shadow-2xl max-w-screen">
      ...
      <div className="flex flex-col items-center lg:px-48 justify-center h-full z-20 text-white gap-6">
        <div className="space-y-3 px-8">
          <motion.h1 className="text-[1.8rem] md:text-5xl lg:text-7xl md:max-w-[1300px] leading-[1.2] max-w-sm w-[600px] font-quicksand text-center font-bold"
          ...
          <motion.p
            className="text-[1.8rem] md:text-5xl lg:text-7xl max-w-3xl font-quicksand text-center text-amber-400 font-semibold"
