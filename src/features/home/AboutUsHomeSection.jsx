...
function AboutUsHomeSection() {
  ...
  return (
    <div className="lg:px-28 xl:px-36 h-auto md:h-auto px-6 text-alpha md:py-12 py-6 w-full md:mb-0 lg:mb-0 max-w-screen bg-[url('/team/pexels-vanessa-loring-5082960.jpg')] bg-cover bg-right relative">
      ...
      <div className="flex relative justify-between gap-6 lg:gap-8 z-10">
        <div className="flex flex-col items-start xl:px-8">
          <motion.h1
            variants={{
            ...
            whileInView="visible"
            className="text-4xl md:text-6xl xl:text-7xl capitalize py-10 font-lora font-medium md:max-w-6xl text-white leading-snug">
