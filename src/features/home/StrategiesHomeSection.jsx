  ...
  {strategies.map((strategy, index) => (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-end bg-opacity-30 p-4 z-10 rounded-lg">
        <div
          className="absolute rounded left-25 md:left-0 top-38 md:top-0 group-hover:left-[20%] md:group-hover:left-[42%] bg-alpha md:px-16 px-12 py-4 flex gap-8 shadow-2xl transition-all duration-1000 opacity-100 md:opacity-0 group-hover:opacity-100 group-hover:top-[45%]"
        >
